...
#[test_case]
fn test_sexdrive_zero_copy_dma() {
    serial_println!("test: Verifying Hardware & sexdrive (Zero-Copy DMA)...");
    ...
    // This routes to standalone sexdrive PD using lent-memory cap
    ...
    serial_println!("test: sexdrive Zero-Copy DMA SUCCESS.");
}
