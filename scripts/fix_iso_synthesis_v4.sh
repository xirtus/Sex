...
# Compatibility mirror at root
cp "$ISO_ROOT/boot/limine/limine.conf" "$ISO_ROOT/limine.conf"

echo "💿 Executing xorriso Synthesis..."
...
echo "✅ SUCCESS: sexos-sasos.iso is ready."
