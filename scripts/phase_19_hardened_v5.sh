#!/bin/bash
# =================================================================
# SexOS Phase 19: Substrate Hardening (The Nuclear Default)
# =================================================================
set -euo pipefail

echo "─── Step 0: Toolchain Force Majeure ───"
rustup default nightly
rustup component add rust-src --toolchain nightly

# Ensure clean slate to prevent toolchain cross-contamination
cargo clean
rm -rf .cargo/config.toml # Clear old config if present
...
echo "─── Step 4: Atomic Synthesis (Direct Nightly) ───"
cargo build \
