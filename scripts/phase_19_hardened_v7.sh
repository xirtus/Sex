#!/bin/bash
# =================================================================
# SexOS Phase 19: Substrate Hardening (Bootstrap Injection)
# =================================================================
set -euo pipefail
...
echo "─── Step 4: Atomic Synthesis (Bootstrap Force) ───"
# RUSTC_BOOTSTRAP=1 bypasses the channel check for -Z flags
