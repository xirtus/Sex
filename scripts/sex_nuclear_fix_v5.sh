...
echo "=========================================="
echo "  SEX MICROKERNEL - V5 AUTOMATION FIX"
echo "  https://github.com/xirtus/sex"
echo "=========================================="

echo "→ Setting nightly as local override..."
rustup override set nightly

echo "→ Installing x86_64-unknown-none on nightly..."
rustup target add x86_64-unknown-none --toolchain nightly

echo "→ Creating .cargo/config.toml (this fixes the core crate error)..."
mkdir -p .cargo
cat > .cargo/config.toml << 'EOF'
[build]
target = "x86_64-unknown-none"
EOF
echo "  .cargo/config.toml created with correct target"
...
echo "=========================================="
echo "SEX Microkernel v5 automation complete."
echo ".cargo/config.toml now forces the correct target → core crate should be found."
